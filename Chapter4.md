...
### Тема 5. Замыкания
1. Какой из приведенных кусков кода выведет поочередно 0 и 1 через 1 сек. ?
  1.
  ```javascript
   for (var i = 0; i < 2; i++) {
...
2. Какой из приведенных кусков кода выведет поочередно 0 и 1 сразу после окончания выполнения цикла?
  1.
  ```javascript
   for (var i = 0; i < 2; i++) {
     setTimeout(function() { alert(i); }, 1000);
...
3. Какой из приведенных кусков кода выведет поочередно 1, 2 и 3 через 1 сек. ?
  1.
  ```javascript
   for (var i = 1; i <= 3; i++) {
     setTimeout(function() { alert(i); }, 1000);
...
4. Какой из приведенных кусков кода выведет поочередно 1, 2, 3 сразу после окончания выполнения цикла?
  1.
  ```javascript
   for (var i = 1; i <= 3; i++) {
     setTimeout(function() { alert(i); }, 1000);
...
5. Какой из приведенных кусков кода выведет поочередно 1, 2 и 3 через 1 сек. ?
  1.
  ```javascript
   for (var i = 1; i <= 3; i++) {
     setTimeout(function() { alert(i); }, 1000);
